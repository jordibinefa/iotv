...
class MQTTClient {
    ...
    connect(host, port = 8084, keepalive = 60, options = {}) {
        ...
        const protocol = port === 8084 || port === 8081 || port === 8000 ? 'wss' : 'ws';
